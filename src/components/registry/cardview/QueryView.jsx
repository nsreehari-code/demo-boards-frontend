...
// `query` kind. Intentionally a duplicate of Searchbox.jsx (two first-class
// kinds, no alias / normalization).
export function QueryView({ spec = {}, data, currentValue, writeTo, onSave }) {
