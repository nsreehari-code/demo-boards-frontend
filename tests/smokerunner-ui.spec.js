...
const RUN_CASE_IDS = ['MB1', 'MB2', 'T0', 'T1', 'T2', 'T3', 'T3u', 'T4', 'T8', 'T8F', 'TR'];
// T9/T9F require a configured Azure AI Foundry endpoint (foundry-forced chat);
// skip them here, consistent with the backend `npm test --skip-tests T9,T9F`.
